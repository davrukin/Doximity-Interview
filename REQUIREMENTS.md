...
| R4  | Live price updates via WebSocket while the app runs | `data/remote/OkHttpPriceSocket`, `data/stream/ReconnectingPriceStream`, `data/repository/PriceRepositoryImpl` | `ReconnectingPriceStreamTest`, `PriceRepositoryImplTest` | ✅ |
...
| R10 | Relevant unit tests | `app/src/test/` (40 tests: data layer + presenters) | `./gradlew testDebugUnitTest` | ✅ |
