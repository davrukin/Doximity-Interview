...
| 2026-06-11 | Sparkline & row states migrated to rememberSaveable                               | Simple remember blocks were cleared on device rotation and screen transitions in Nav3; migrated to rememberSaveable with custom DoubleArray Saver to persist state.                   |
